    ...
    return (
        <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
            ...
            <div className="w-full lg:w-1/2">
                ...
                <p className="py-4 text-base text-gray-800">El contenido que buscas no existe. O lo eliminaron o escribiste mal el enlace.</p>
                <p className="py-2 text-base text-gray-800">¡Lo lamento! Visite nuestra página de inicio para llegar a donde necesita ir.</p>
